...
const Leftbar = () => {
  return (
    <div className="flex items-center justify-center gap-3 pl-1 lg:pl-4">
      <Link href="/">
        <div className="flex items-center justify-center h-12 rounded-lg cursor-pointer select-none w-14 hover:bg-gray-700" >
      ...
      <Link href="/about">
        <div className="relative flex items-center justify-center w-20 h-12 font-normal text-white rounded-lg cursor-pointer select-none lg:w-28 hover:bg-gray-700">
          About Me
        </div>
      </Link>
